  ...
  return (
    <section id="tarifas" className="bg-neoprene px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
      <Reveal className="text-center">
        ...
        <a
          href="#contacto"
          className="group mx-auto mt-10 inline-flex items-center gap-2 border border-white/30 px-8 py-4 font-split text-xs uppercase tracking-widest text-white transition-colors hover:border-atlantico hover:bg-white/10"
        >
          Pide tu plan
