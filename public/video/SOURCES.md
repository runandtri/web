...
All clips are free for commercial use. For production, the remote ones should
also be downloaded and self-hosted (as `triatlon-salida.mp4` already is).
...
| start | Pixabay | Pixabay Content License — pixabay.com video 29661.
          ...
          Best replaced with Berto's own race footage when available. |

## CC BY-SA 4.0 clips (require visible credit; edits stay CC BY-SA)
- `triatlon-carrera.mp4` — "2019 Montevideo Sprint Triathlon American Cup –
  Elite men's race – 05" by **NaBUru38**, via Wikimedia Commons, CC BY-SA 4.0.
  Cropped/compressed. REQUIRED credit (e.g. site footer):
  "Vídeo: NaBUru38 / Wikimedia Commons, CC BY-SA 4.0".
